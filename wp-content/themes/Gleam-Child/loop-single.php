<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
	...
	<article class="entry post">
		...
		<div class="post-content clearfix">
			...
			<?php } ?>
			<?php the_content(); ?>
			<?php $contact = get_post_meta($post->ID, 'contact_email', true); ?>
			<?php if ($contact <> '') { ?>
				<p><i>This column was published in the Perry Co Times on <?php the_date('d F Y'); ?></i></p>
				<p><i>For more information, please contact Mr. Olshan at <a href="mailto:<?php echo $contact; ?>"><?php echo $contact; ?></a></i></p>
			<?php } ?>
